function getComputerChoice() {
  ...
  function getHumanChoice() {
    // Declare choiceInput variable and assign it to a prompt where the user enters in a choice
  ...
  function playGame() {
    console.log("--------------------");
    // Declare variables which get choices for the human and computer
